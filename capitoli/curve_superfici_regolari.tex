...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{Spazio delle funzioni vettoriali di classe $C^k$}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{Della funzione inversa}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{Della funzione implicita rispetto a $x$}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{Della funzione implicita rispetto a $y$}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{Curva regolare}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{Funzione implicita rispetto a $y$ e $z$}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{Della funzione implicita rispetto a $x$ e $y$}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{Superficie regolare}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{Spazio tangente}]
...
\vspace{0.5cm}
\begin{prop}[\textcolor{blue}{Dimensione dello spazio tangente}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{Spazio delle velocità}]
...
\begin{theorem}[\textcolor{blue}{Caratterizzazione del tangente}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{Punti critici su curve/superfici}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{Dei punti critici}]
...
\begin{theorem}[\textcolor{blue}{Di Fermat su $\Sigma$}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{Dei moltiplicatori di Lagrange}]
