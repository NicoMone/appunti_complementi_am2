...
%
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{$k-$forma algebrica esterna}]
...
%
\vspace{0.5cm}
\begin{cor}[\textcolor{blue}{le $n-$forme sono volumi di parallelepipedi}]
...
%
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{prodotto esterno fra una $k-$forma e una $l-$forma}]
