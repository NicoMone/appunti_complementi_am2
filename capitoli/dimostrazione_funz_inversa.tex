...
%
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{spazio delle applicazioni lineari}]
...
%
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{norma matriciale indotta}]
...
%
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{equivalenza fra norme}]
...
%
\vspace{0.5cm}
\begin{prop}[\textcolor{blue}{tutte le norme sono equivalenti a quella euclidea su $\mathbb{R}^n / \, \mathbb{C}^n$}]
...
%
\vspace{0.5cm}
\begin{cor}[\textcolor{blue}{tutte le norme sono equivalenti in $\mathbb{R}^n / \, \mathbb{C}^n$}]
...
%
\vspace{0.5cm}
\begin{cor}[\textcolor{blue}{tutte le norme sono equivalenti su spazi di dimensione finita}]
...
%
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{di Banach-Caccioppoli}]
...
%
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{criterio di Lipschtiz}]
...
%
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{continuità dell'operazione di inversione di una matrice}]
...
\noindent \textbf{Dimostrazione. } [Dimostrazione (del teorema \ref{thm:inverse_function})]
	...
	\[\begin{aligned}
	|T(x) - x_0| \stackrel{\text{dis. triang.}}{\leq} &\ |T(x) - T(x_0)| + |T(x_0) - x_0|\ \leq\\  
	&\leq\ \frac{1}{2} |x-x_0| + |A(y - y_0)| \leq \frac{\rho}{2} + || A || r = \\
    ...
    \[\begin{aligned}
    \frac{g(y') - g(y) - Df(x)^{-1}(f(x')-f(x))}{|y' - y|} 
    &= \frac{x' - x - Df(x)^{-1}(Df(x)(x'-x) + o(|x' - x|))}{|y' - y|} = \\
    &=\ \frac{Df(x)^{-1}(o(|x'-x|))}{|y'-y|}\ =\\
    &=\  \frac{Df(x)^{-1}(o(|x'-x|))}{|x'-x|} \frac{|x'-x|}{|y'-y|}\ \ .
    \end{aligned}\]
