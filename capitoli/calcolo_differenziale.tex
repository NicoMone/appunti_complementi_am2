...
%
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{derivata direzionale}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{DF1}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{rappresentazione e unicità del differenziale}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{gradiente di una funzione}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{spazio duale}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{1-forma differenziale}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{campo vettoriale}]
...
&=\ \begin{pmatrix} \partial_{x_1} f_1(p_0) & \ldots & \partial_{x_n} f_1(p_0) \\
\vdots & \vdots & \vdots \\
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{del differenziale totale}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{norma di Hilbert-Schmidt}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{differenziale della composizione}]
...
\vspace{0.5cm}
\begin{prop}[\textcolor{blue}{differenzialità $\iff$ derivabilità}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{piano in uno spazio euclideo}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{di Schwarz}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{di Schwarz di ordine superiore}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{spazio $C^k$}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{differenziali di ordine superiore}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{forma quadratica}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{polinomio di $n$ variabili omogeneo}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{polinomio di Taylor di $f$ in $x_0$ di ordine $k$}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{formula di Taylor}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{unicità del polinomio di Taylor}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{forma quadratica definita positiva o negativa}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{forma quadratica semi-definita positiva o semi-definita negativa}]
...
\begin{theorem}[\textcolor{blue}{criterio di Sylvester}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{di Fermat}]
...
\vspace{0.5cm}
\begin{definition}[\textcolor{blue}{punto critico}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{condizione sufficiente per il massimo/minimo locale}]
...
\vspace{0.5cm}
\begin{theorem}[\textcolor{blue}{dei punti di sella}]
