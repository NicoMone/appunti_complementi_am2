...
\begin{theorem} Sia $(V, \varphi)$ uno spazio euclideo. Allora 
	\[\forall \underline{v}, \underline{w} \in V, \innerprod{\underline{v}}{\underline{w}} = |\underline{v}| \, | \underline{w} | \cos{\hat{\theta}}\]
dove $\hat{\theta}$ è l'angolo convesso fra i due vettori $\underline{v}$ e $\underline{w}$
\end{theorem}

\noindent\textbf{Dimostrazione. }  \hfill $\square$
